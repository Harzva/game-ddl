...
const payload = JSON.stringify({
  results_html: `
    <a href="https://store.steampowered.com/app/1234560/Example_Game/?snr=1" data-ds-appid="1234560">
      <img src="http://cdn.cloudflare.steamstatic.com/steam/apps/1234560/header.jpg">
    ...
    <a data-ds-appid="2345670" href="https://store.steampowered.com/app/2345670/Fuzzy_Game/">
      <img src="https://cdn.cloudflare.steamstatic.com/steam/apps/2345670/capsule_231x87.jpg">
...
assert.equal(rows[0].imageUrl, 'https://cdn.cloudflare.steamstatic.com/steam/apps/1234560/header.jpg');
...
assert.equal(items[0].imageUrl, 'https://cdn.cloudflare.steamstatic.com/steam/apps/1234560/header.jpg');
...
const merged = buildSteamItems([
  {
    ...
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/9999990/header.jpg',
...
assert.equal(merged[0].imageUrl, 'https://cdn.cloudflare.steamstatic.com/steam/apps/9999990/header.jpg');
